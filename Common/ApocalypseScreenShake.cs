...
public class ApocalypseScreenShake : ICameraModifier
{
    ...
    public void Update(ref CameraInfo cameraInfo)
    {
        ...
        cameraInfo.CameraPosition = Vector2.Lerp(cameraInfo.CameraPosition, targetPos, lerpAmount * ModContent.GetInstance<MajorasMaskTributeConfig>().ScreenShakeStrength);
